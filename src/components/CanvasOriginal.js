...
// <CanvasOriginal navPosition={this.state.navPosition} category={'brand'} />
//   <CanvasOriginal navPosition={this.state.navPosition} shape={'triangles'} />
//   <CanvasOriginal navPosition={this.state.navPosition} shape={'triangles'} />
//   <CanvasOriginal navPosition={this.state.navPosition} shape={'triangles'} />
//   <CanvasOriginal navPosition={this.state.navPosition} shape={'triangles'} />
//   <CanvasOriginal navPosition={this.state.navPosition} shape={'triangles'} />
//   <CanvasOriginal navPosition={this.state.navPosition} shape={'tooManyTriangles'} />
//   <Watermark />
//   <Footer
    ...
    return (
      <CanvasComponent>
        {/* <div>
          ...
          {
            // let's re-add all those triangles
            this.props.shape === "tooManyTriangles" &&
